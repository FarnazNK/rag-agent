...
"""),
    ("sick_leave_policy.md", """# Sick Leave Policy
...
"""),
    ("parental_leave_policy.md", """# Parental Leave Policy
...
"""),
    ("bereavement_leave.md", """# Bereavement Leave
...
"""),
    ("pip_policy.md", """# Performance Improvement Plan (PIP)
...
"""),
    ("promotion_calibration.md", """# Promotion Calibration Process
...
"""),
    ("equity_grants.md", """# Equity Grant Policy
...
"""),
    ("buddy_program.md", """# Onboarding Buddy Program
...
"""),
    ("first_day_checklist.md", """# First Day Checklist
...
"""),
    ("home_office_stipend.md", """# Home Office Stipend Details
...
"""),
    ("workspace_security.md", """# Remote Workspace Security
...
"""),
    ...
    # ----- IT / Security -----
    ("password_policy.md", """# Password Policy
...
"""),
    ("software_installation.md", """# Software Installation Policy
...
"""),
    ("byod_policy.md", """# Bring Your Own Device (BYOD)
...
"""),
    ...
    # ----- Engineering -----
    ("code_review_policy.md", """# Code Review Policy
...
"""),
    ("incident_postmortems.md", """# Incident Postmortems
...
"""),
    ("deploy_freezes.md", """# Deployment Freeze Calendar
...
"""),
    ("repository_standards.md", """# Repository Standards
...
"""),
    ("python_style_guide.md", """# Python Style Guide (Excerpts)
...
"""),
    ("travel_booking.md", """# Travel Booking
...
"""),
    ("corporate_card.md", """# Corporate Card Policy
...
"""),
    ...
    # ----- Benefits -----
    ("health_insurance.md", """# Health Insurance
...
"""),
    ("wellness_stipend.md", """# Wellness Stipend
...
"""),
    ("learning_stipend.md", """# Learning & Development Stipend
...
expense category.
"""),
    ("commuter_benefits.md", """# Commuter Benefits
...
"""),
    ("employee_assistance.md", """# Employee Assistance Program (EAP)
...
"""),
    ...
    # ----- HR / Employment -----
    ("equal_opportunity.md", """# Equal Opportunity Statement
...
"""),
    ("anti_harassment.md", """# Anti-Harassment Policy
...
"""),
    ("outside_employment.md", """# Outside Employment
...
approval.
"""),
    ("non_compete.md", """# Non-Compete Provisions
...
you signed.
"""),
    ("offboarding.md", """# Offboarding Process
...
"""),
    ("references_policy.md", """# References Policy
...
"""),
    ...
    ("meeting_norms.md", """# Meeting Norms
...
"""),
    ("slack_etiquette.md", """# Slack Etiquette
...
"""),
    ("doc_writing_standards.md", """# Doc Writing Standards
...
"""),
    ...
    # ----- Hiring -----
    ("hiring_process.md", """# Hiring Process
...
"""),
    ("interview_panel_diversity.md", """# Interview Panel Composition
...
"""),
    ("referral_program.md", """# Employee Referral Program
...
"""),
    ("pet_policy.md", """# Pets in the Office
...
"""),
    ("office_amenities.md", """# Office Amenities
...
"""),
    ("holiday_calendar.md", """# Company Holidays
...
"""),
    ("internal_transfers.md", """# Internal Transfers
...
manager discretion.
"""),
    ("intellectual_property.md", """# Intellectual Property Assignment
...
"""),
    ("open_source_policy.md", """# Open Source Contributions
